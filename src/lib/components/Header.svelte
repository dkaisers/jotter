...
<div class="mx-auto w-full max-w-[60rem] px-4 pt-6 sm:px-6 sm:pt-8">
	<div class="flex items-center justify-between">
		...
		<a
			...
			class="flex h-8 w-8 cursor-pointer items-center justify-center rounded-md text-on-surface-variant transition-colors hover:bg-surface hover:text-on-surface focus:outline-none"
		>
			<svg
				class="size-4"
				viewBox="0 0 24 24"
...
<main class="mx-auto w-full max-w-[60rem] flex-1 px-4 pt-5 pb-12 sm:px-6 sm:pt-6">
	{@render children()}
</main>
